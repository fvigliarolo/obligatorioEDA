...
int main()
{
	...
	do{/*
		...
		cout << "\tsalir()\n\n";*/
		cout << "> ";
		fflush( stdin ); 	//borrar (o vaciar) el búfer de salida
		ejecutado = false;
		
		fgets (comando, MAX_COMANDO, stdin); //reads a line from the specified stream and stores it into the string pointed to by str.

		pch = strtok (comando,"( ,)"); //divide lo que venga en "comando" segun la ocurrencia de los simbolos del parametro 2
